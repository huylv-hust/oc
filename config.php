<?php
// HTTP
define('HTTP_SERVER', $_SERVER['REQUEST_SCHEME'].'://'.$_SERVER['HTTP_HOST'].'/oc/');

// HTTPS
define('HTTPS_SERVER', $_SERVER['REQUEST_SCHEME'].'://'.$_SERVER['HTTP_HOST'].'/oc/');

// DIR
define('DOCUMENT_ROOT',$_SERVER['DOCUMENT_ROOT']);
define('DIR_APPLICATION', DOCUMENT_ROOT.'oc/catalog/');
define('DIR_SYSTEM', DOCUMENT_ROOT.'oc/system/');
define('DIR_LANGUAGE', DOCUMENT_ROOT.'oc/catalog/language/');
define('DIR_TEMPLATE', DOCUMENT_ROOT.'oc/catalog/view/theme/');
